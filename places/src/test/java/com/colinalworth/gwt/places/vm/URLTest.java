...
//	}
	...
	public void testDecode() {
		...
		Assert.assertEquals(DECODED_URL, actualURL);
	}
	...
	public void testDecodeComponent() {
		...
		Assert.assertEquals(DECODED_URL_COMPONENT, actualURLComponent);
...
//		}
	...
	public void testEncode() {
		...
		Assert.assertEquals(ENCODED_URL, actualURL);
	}
	...
	public void testEncodeComponent() {
		...
		Assert.assertEquals(ENCODED_URL_COMPONENT_QS, actualURLComponent);
	}
	...
	public void testEncodeComponent2() {
		...
		Assert.assertEquals(ENCODED_URL_COMPONENT, actualURLComponent);
